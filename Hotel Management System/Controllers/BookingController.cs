...
namespace Hotel_Management_System.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult Create(Booking booking)
        {
            ...
            // Manually assigning GuestName (instead of fetching from Identity)
            booking.GuestName ??= "Guest"; // Default name if not provided
        ...
        private decimal CalculateTotalPrice(decimal pricePerNight, DateTime checkInDate, DateTime checkOutDate)
        {
